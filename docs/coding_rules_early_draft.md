...
> **Superseded.** This is the early codebook draft, predating the two
> numbered versions and kept for provenance. The current codebook is
> `coding_rules.md`, at version 2. This draft's section 5 carries only
> the markets/rates/transmission exclusion and section 6 carries no
> technical-and-operational-risk exclusion at all, which dates the
> misfiling to the revision that produced version 1.
...
or monetary-policy transmission are mentioned.
